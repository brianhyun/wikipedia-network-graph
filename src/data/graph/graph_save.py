...
articles_of_interest = ["Leonardo da Vinci", "Black hole", "The Butterfly Effect", "Machine learning", "Alan Turing"]
...
for article in articles_of_interest:
    ...
    article = article.lower().replace(' ', '_')

    with open(f"{article}_d2_l30.json", "w") as f:
